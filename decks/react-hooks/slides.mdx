...
<Image size="contain" src="https://i.imgur.com/axp99f1.png" />
...
<Image size="contain" src="https://i.imgur.com/NW9osQq.png" />
...
```notes
Abstracting functionality by _behaviour_ not by lifecycle method
```
...
**Compose reusable behaviours** within a component,
...
Use 3rd party modules to add complex behaviours without:
