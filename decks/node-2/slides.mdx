...
<ol>
  <Appear>
    <li>
      ...
      <span style={{ float: "right", marginLeft: "5rem" }}>GET /albums</span>
    </li>
    <li>
    ...
    <li>
      Create a new album{" "}
      <span style={{ float: "right", marginLeft: "5rem" }}>POST /albums</span>
    </li>
    <li>
      Delete an album{" "}
      <span style={{ float: "right", marginLeft: "5rem" }}>
...
<Notes>
  Share link in Slack
  <br />
  Allow 15 minutes, get TAs to report progress to adjust timings
</Notes>
...
<Notes>Quick note on `--save-dev`</Notes>
...
<Notes>
  ...
  <br />
  Not necessary on Glitch
</Notes>

---

# Step 2: `GET /albums/:albumId`

## Returns a single album by its ID

[Remix `cyf-get-by-id-starter` on Glitch](https://glitch.com/edit/#!/remix/cyf-get-by-id-starter)

<Notes>
  req.params
  <br />
  leave implementation of 'find' and 'send' to students
</Notes>
...
### `GET /albums/:albumId` returns a single album by its ID
...
<Notes>
  Share link in Slack
  <br />
  Allow 20 minutes, get TAs to report progress to adjust timings
</Notes>
...
[Remix `cyf-add-new-starter` on Glitch](https://glitch.com/edit/#!/remix/cyf-add-new-starter)

<Notes>
  Express can't understand JSON bodies by itself
  <br />
  Middleware
  <br />
  `app.use` - 'use for all requests'
</Notes>
...
### `DELETE /albums/:albumId` deletes a single album by its ID

[Remix `cyf-delete-by-id-starter` on Glitch](https://glitch.com/edit/#!/remix/cyf-delete-by-id-starter)
